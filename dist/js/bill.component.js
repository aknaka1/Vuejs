...
window.billComponent = Vue.extend({
    ...
    created: function created() {
        //Roda depois de ter carregado todo DOM
    ...
    data: function data() {
        return {
            menus: [{ name: "Dashboard", routeName: 'dashboard' }, { name: "Contas a pagar", routeName: 'bill-pay.list', dropdownId: 'bill-pay' }, { name: "Contar a receber", routeName: 'bill-receive.list', dropdownId: 'bill-receive' }],
            menusDropdown: [{
